...
public class Session implements AutoCloseable, Comparable<Session> {
	...
	public Session(Configuration refConfig, BasicSocket basicSocket, Sender sender) {
	...
	public BasicSocket getBasicSocket() {
		return basicSocket;
	}
	...
	@Override
	public int compareTo(Session toComparate) {
